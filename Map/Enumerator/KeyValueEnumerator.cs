...
public struct MapKeyEnumerator<TK, TV> : IEnumerator<TK>
{
    ...
    {
        _inner = new MapEnumerator<TK, TV>(root);
    }
...
public readonly struct MapKeyCollection<TK, TV> : IReadOnlyCollection<TK>
{
    ...
    public MapKeyEnumerator<TK, TV> GetEnumerator()
    {
        return new MapKeyEnumerator<TK, TV>(_root);
    }
...
public readonly struct MapValueCollection<TK, TV> : IReadOnlyCollection<TV>
{
    ...
    public MapValueEnumerator<TK, TV> GetEnumerator()
    {
        return new MapValueEnumerator<TK, TV>(_root);
    }
